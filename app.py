...
class App(tk.Tk):
    ...
    def generar_recibo_pago(self):
        ...
        y -= 20
        c.drawString(50, y, f"Concepto: {Perfecto, Antonio. Vamos a **crear los archivos del proyecto directamente desde tu iPhone**, de forma que puedas subirlos a GitHub sin tocar un PC.  
Te dejo **cada archivo listo para copiar y pegar**, con el nombre exacto que debes darle.

---

# 🟩 1. Crear archivo `app.py`
En la app de GitHub (iOS):
